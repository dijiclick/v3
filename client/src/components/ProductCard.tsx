      ...
      <div className={`bg-white dark:bg-card rounded-xl border border-gray-200 dark:border-border overflow-hidden hover:shadow-xl transition-all duration-300 group ${
        ...
        <div className="relative aspect-[4/3] overflow-hidden">
          ...
          <div className="absolute top-3 left-3 opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            >
              <Heart className={`h-4 w-4 ${isWishlisted ? 'fill-current text-green-500' : ''}`} />
            </Button>
          </div>
          ...
          <div className="absolute top-3 right-3 flex flex-col gap-2">
            {hasDiscount && (
              <Badge 
                variant="destructive" 
                className="bg-green-500 hover:bg-green-600 text-white font-bold px-2 py-1 text-xs rounded-lg shadow-lg"
