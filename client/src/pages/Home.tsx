          ...
          <section className="text-center py-16">
            <div className="mb-12">
              ...
              <h2 className="text-4xl font-bold text-gray-800 relative inline-block">
                چگونه کار می‌کند؟
                <div className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 w-20 h-1 bg-gradient-to-r from-green-400 to-green-500 rounded"></div>
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
              {[
                ...
                <div 
                  key={index}
                  className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100 hover:-translate-y-2 hover:shadow-xl hover:border-green-200 transition-all"
